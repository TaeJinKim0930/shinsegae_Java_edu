...
/**
 * GET 방식으로 /todo/input 경로로 호출할때 처리되는 컨트롤러이다.
 */
@WebServlet(name = "inputContoller", urlPatterns = "/todo/input")
public class InputController2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/todo/input.jsp");
